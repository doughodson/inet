...
INET_API extern GlobalSerializerRegistrationList serializers; ///< List of packet serializers (ISerializer)

//#define Register_Serializer(SERIALIZABLECLASSNAME, PROTOCOLGROUP, PROTOCOLID, SERIALIZERCLASSNAME)   \
//        static cObject *MAKE_UNIQUE_WITHIN_FILE(__factoryfunc_)() {cObject *ret = new SERIALIZERCLASSNAME; return ret; } \
//        static void *MAKE_UNIQUE_WITHIN_FILE(__castfunc_)(cObject *obj) {return (void*)dynamic_cast<CLASSNAME*>(obj);} \
//        EXECUTE_ON_STARTUP(serializers.getInstance()->add(SERIALIZABLECLASSNAME, PROTOCOLGROUP, PROTOCOLID, new SERIALIZERCLASSNAME);)
